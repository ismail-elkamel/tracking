...
def main() -> None:
    parser = argparse.ArgumentParser(description="Export an instrument segmentation checkpoint to ONNX.")
    parser.add_argument("--checkpoint", default="instrument_segmentation/runs/instrument_model/best.pt")
    parser.add_argument("--output", default="instrument_segmentation/runs/instrument_model/best.onnx")
