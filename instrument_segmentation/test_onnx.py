...
from instrument_segmentation.inference import preprocess_numpy, save_overlay, sigmoid
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Test an ONNX instrument segmentation model on new images.")
    ...
    parser.add_argument("--output-dir", default="instrument_segmentation/runs/onnx_predictions")
    ...
    for image_path in image_paths:
        ...
        output_path = output_dir / f"{image_path.stem}_instrument_overlay.png"
