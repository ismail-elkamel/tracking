...
from kidney_segmentation.inference import overlay_mask, preprocess_numpy, sigmoid
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ONNX kidney segmentation on a video.")
    parser.add_argument("--onnx", default="kidney_segmentation/runs/kidney_model/best.onnx")
    parser.add_argument("--video", required=True)
    parser.add_argument("--output", default="kidney_segmentation/runs/kidney_video_overlay.mp4")
